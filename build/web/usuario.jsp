        ...
        <main class="registro__container">
            <section class="container">
                <form action="CControlador" method="get">
                    <div class="btn--nuevo">
                        <button ><a href="usuario.jsp">Nuevo</a></button>
                    </div>
                    <div class="buscar">
                ...
                <div class="table--container">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td><%=u.isEstado()%></td>
                            <td>
                                <a href="modificarUsuario.jsp?accion=modificarUsuario&id=<%=u.getId_empleado()%>">Modificar</a>
                                /
                                <a href="CControlador?accion=eliminarUsuario&id=<%=u.getId_empleado()%>">Eliminar</a>
                            </td>
                        </tr>
                        <%
                            }
